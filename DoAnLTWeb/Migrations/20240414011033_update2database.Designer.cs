...
namespace DoAnLTWeb.Migrations
{
    ...
    [Migration("20240414011033_update2database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Banner", b =>
                {
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.DeliveryNote", b =>
                {
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Footer", b =>
                {
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Image", b =>
                {
                    b.Property<int>("Idimages")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.ImportedProduct", b =>
                {
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.ImportedProductsDetail", b =>
                {
                    b.Property<int>("IdimportedProducts")
                        .HasColumnType("int")
                        .HasColumnName("IDImportedProducts");
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Invoice", b =>
                {
                    b.Property<int>("Idinvoice")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Invoicedetail", b =>
                {
                    b.Property<int>("Idinvoice")
                        .HasColumnType("int")
                        .HasColumnName("IDInvoice");
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Product", b =>
                {
                    b.Property<int>("Idproduct")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.ProductType", b =>
                {
                    b.Property<int>("IdproductType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.ShoppingCartDeltail", b =>
                {
                    b.Property<int>("IdshoppingCart")
                        .HasColumnType("int")
                        .HasColumnName("IDshoppingCart");
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Skill", b =>
                {
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.SkillDetail", b =>
                {
                    b.Property<int>("IdSkill")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Staff", b =>
                {
                    b.Property<int>("Idstaff")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.StaffType", b =>
                {
                    b.Property<int>("IdstaffType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Supplier", b =>
                {
                    b.Property<int>("Idsupplier")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Warehouse", b =>
                {
                    b.Property<int>("Idwarehouse")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Warehousedetail", b =>
                {
                    b.Property<int>("Idwarehouse")
                        .HasColumnType("int")
                        .HasColumnName("IDWarehouse");
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Banner", b =>
                {
                    b.HasOne("DoAnLTWeb.Models.Image", "IdimagesNavigation")
                        .WithMany("Banners")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Customer", b =>
                {
                    ...
                    b.HasOne("DoAnLTWeb.Models.User", "UsernameNavigation")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.DeliveryNote", b =>
                {
                    b.HasOne("DoAnLTWeb.Models.Invoice", "IdinvoiceNavigation")
                        .WithMany("DeliveryNotes")
                        .HasForeignKey("Idinvoice")
                        .IsRequired()
                        .HasConstraintName("FK_DeliveryNotes_Invoice");

                    b.HasOne("DoAnLTWeb.Models.Staff", "IdstaffNavigation")
                        .WithMany("DeliveryNotes")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.ImportedProduct", b =>
                {
                    ...
                    b.HasOne("DoAnLTWeb.Models.Warehouse", "IdwarehouseNavigation")
                        .WithMany("ImportedProducts")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.ImportedProductsDetail", b =>
                {
                    b.HasOne("DoAnLTWeb.Models.ImportedProduct", "IdimportedProductsNavigation")
                    ...
                    b.HasOne("DoAnLTWeb.Models.Product", "IdproductNavigation")
                        .WithMany("ImportedProductsDetails")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Invoice", b =>
                {
                    b.HasOne("DoAnLTWeb.Models.Customer", "IdcustomerNavigation")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Product", b =>
                {
                    b.HasOne("DoAnLTWeb.Models.ProductType", "IdproductTypeNavigation")
                        .WithMany("Products")
                        .HasForeignKey("IdproductType")
                        .IsRequired()
                        .HasConstraintName("FK_Product_ProductType");

                    b.HasOne("DoAnLTWeb.Models.Supplier", "IdsupplierNavigation")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.ShoppingCartDeltail", b =>
                {
                    ...
                    b.HasOne("DoAnLTWeb.Models.ShoppingCart", "IdshoppingCartNavigation")
                        .WithMany("ShoppingCartDeltails")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.SkillDetail", b =>
                {
                    b.HasOne("DoAnLTWeb.Models.Skill", "IdSkillNavigation")
            ...
            modelBuilder.Entity("DoAnLTWeb.Models.Staff", b =>
                {
                    ...
                    b.HasOne("DoAnLTWeb.Models.StaffType", "IdstaffTypeNavigation")
                        .WithMany("Staff")
            ...
            modelBuilder.Entity("ProductImagesDetail", b =>
                {
                    b.HasOne("DoAnLTWeb.Models.Image", null)
                        .WithMany()
                        .HasForeignKey("Idimages")
                        .IsRequired()
                        .HasConstraintName("FK_ProductImagesDetails_Images");

                    b.HasOne("DoAnLTWeb.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("Idproduct")
                        .IsRequired()
